            ...
            <div class="row gx-3">
                <aside class="col-lg-6">
                    ...
                    <div class="d-flex justify-content-center mb-3">
                        ...
                        <div data-fslightbox="mygallery" class="border mx-1 rounded-2" data-type="image">
                            <img width="60" height="60" class="rounded-2"
                                src="{{ asset("images/uploads/$product->Image3") }}" onclick="updateBigImage(this)" />
                        </div>
                    </div> 
                </aside>
                        ...
                        @else
                            ...
                            <form action="{{ route('cart.store', "product_id=$product->id") }}" method="POST">
                                ...
                                <div class="d-flex">
                                    <div class="w-25">
                                        @php
                                            $myquantity = $product->Quantity
                                        @endphp
                                        <input type="number" name="quantity" id="quantity"
                                            class="form-control " placeholder="quantity" max="{{ $product->Quantity }}" min="1" required @if ($myquantity >= 1)  
                                        value="1"
                                            @endif >
                                            @error('quantity')
