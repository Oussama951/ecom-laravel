<nav class="navbar sticky-top" style="background-color: #4682B4;">
    <div class="container">
        {{-- Logo --}}
        <a class="navbar-brand" href="/">
            <img src="{{ asset('images/Logo.png') }}" style="width:4rem!important" />
        </a>
        {{-- header's center nav --}}
                ...
                @guest
                    <li class="p-3">
                        <div class="btn-group">
                            ...
                            <button type="button" class="nav-link ms-2 dropdown-toggle dropdown-toggle-split"
                                data-bs-toggle="dropdown" aria-expanded="false">
                                <span class="visually-hidden"></span>
                            </button>
                            <ul class="dropdown-menu p-3" style="background-color: #4682B4">
                                <li>
